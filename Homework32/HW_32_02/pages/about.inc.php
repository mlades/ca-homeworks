<?php 
    if(isset($_POST["sub_email"]) && !empty($_POST["sub_email"])) {
        $link = mysqli_connect('127.0.0.1', 'homestead', 'secret', 'company');

        $subEmail = $_POST["sub_email"];

        $sql = "INSERT INTO subscriptions VALUES (NULL, '$subEmail');";
                    ...
                    <div class="col-md-6 col-sm-12 border mt-4 mx-2 p-4 rounded shadow">
                        <div class="form">
                            ...
                            <form class="form-group" method="POST">
                                <input type="text" class="form-control" name="sub_email" placeholder="Enter E-mail">
                                <br>
